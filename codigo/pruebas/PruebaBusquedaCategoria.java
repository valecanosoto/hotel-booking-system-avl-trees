...
public class PruebaBusquedaCategoria {

    public static void main(String[] args) {
        // Creamos el árbol AVL con el comparador por categoría
        ArbolAVL<Hotel> arbolHoteles = new ArbolAVL<>(new ComparadorCategoria());

        // Insertamos hoteles
        insertarHoteles(arbolHoteles);

        System.out.println("\nÁrbol de hoteles (ordenado por Categoría):");
        arbolHoteles.imprimirArbol();

        // Solicitamos categoría al usuario
        Scanner scanner = new Scanner(System.in);
        System.out.println("\nIngrese la categoría para buscar hoteles:");
        int categoria = scanner.nextInt();

        // Creamos una clave de búsqueda ficticia con solo la ciudad
        Hotel claveBusqueda = new Hotel(0, null, null, null, null, null, categoria);
